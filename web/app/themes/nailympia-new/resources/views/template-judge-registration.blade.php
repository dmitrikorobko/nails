{{--
  Template Name: Judge Registration
--}}
...
@section('content')
  @while(have_posts()) @php the_post() @endphp
    <form class="registration-form" id="judge" enctype = 'multipart/form-data' data-language={{ICL_LANGUAGE_CODE}}>
        <div class="step-item active" data-step="step-1">
            @include('partials.form-userdata', ['form' => 'judge'])
    ...
    @include('partials.form-modal', ['form' => 'judge'])
  @endwhile
@endsection
