...
<div style="padding: 10px 0 50px 0; text-align: center;"><a style="background: #555555; color: #fff; padding: 12px 30px; text-decoration: none; letter-spacing: 0.3px;" href="{login_url}">Login to our site</a></div>
